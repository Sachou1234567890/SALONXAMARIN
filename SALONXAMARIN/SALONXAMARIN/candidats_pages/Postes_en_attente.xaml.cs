...
namespace SALONXAMARIN.candidats_pages
{
    ...
    public partial class Postes_en_attente: ContentPage
    {
        FirebaseClient firebase;
        private Person currentUser;

        Dictionary<string, List<string>> emploiParEvenement;
        public Postes_en_attente(Person currentUser)
        {
            InitializeComponent();
        ...
        private async Task<List<Emploi>> GetEmploisEnAttente(string personId)
        {
            try
            {
    ...
    public class Emploi_en_attenteViewModel : BindableObject
    {
